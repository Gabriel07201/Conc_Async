...
async def pegar_links():
    links = []
    async with aiofiles.open(r'C:\Users\Gabriel\Desktop\Programação\Conc_Async\Secao_5\links.txt') as arquivo:
...
async def pegar_html(link):
    print(f'Pegando o html de {link}')
